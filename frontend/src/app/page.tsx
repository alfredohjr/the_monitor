...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen items-center justify-center p-6 sm:p-24 relative overflow-hidden bg-zinc-50 text-zinc-900 dark:bg-[#0a0a0a] dark:text-white">
